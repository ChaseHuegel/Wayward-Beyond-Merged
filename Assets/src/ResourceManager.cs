    ...
    public class ResourceManager : ScriptableObject
    {
		...
		public void Initialize()
		{
			...
			foreach (string file in Directory.GetFiles(path, "*.png"))
			{
				...
				imageResources.Add( new ImageResource( "item." + imgName, new CachedImage(texture, imgName) ) );
			}
			...
			foreach (string file in Directory.GetFiles(path, "*.png"))
			{
				...
				imageResources.Add( new ImageResource( "atlas." + imgName, new CachedImage(texture, imgName) ));
			}
			...
			foreach (string file in Directory.GetFiles(path, "*.png"))
			{
				...
				imageResources.Add( new ImageResource( "char." + imgName, new CachedImage(texture, imgName) ));
			}
		}
