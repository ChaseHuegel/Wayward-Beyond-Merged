...
public class SeparatingAxisTest : MonoBehaviour {
	...
	public float minOverlap = 0;
	public Vector3 minOverlapAxis = Vector3.zero;

	public Vector3 pushoutVector = Vector3.zero;
	...
	void Update () {
		...
		if ( CheckCollision(_cubeA, _cubeB))
		{
			...
			Debug.DrawRay(_cubeA.Transform.position, minOverlapAxis * minOverlap, Color.cyan);
			_cubeA.Transform.position += minOverlapAxis * minOverlap;
		}
		else
		{
